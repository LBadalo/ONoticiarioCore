    ...
    public partial class DB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2019, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Comentário de teste", 1, 3 },
                    { 2, new DateTime(2019, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), "Comentário de teste", 2, 2 }
                });
