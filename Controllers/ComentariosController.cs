...
namespace ONoticiarioCore.Controllers
{
    public class ComentariosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Comentarios.Include(c => c.Noticia).Include(c => c.Utilizador);
        ...
        {
            ViewData["NoticiasFK"] = new SelectList(_context.Noticias, "ID", "Conteudo");
        ...
        public async Task<IActionResult> Create([Bind("ID,Descricao,UtilizadorFK,Data,NoticiasFK")] Comentarios comentarios)
        {
